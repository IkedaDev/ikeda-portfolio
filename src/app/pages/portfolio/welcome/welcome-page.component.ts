...
export class WelcomePageComponent implements OnInit {
  ...
  public serviceCards = signal<ServiceCard[]>([
    {
      ...
      description:
        'Como desarrollador web, me especializo en la creación de sitios web robustos y escalables, utilizando tecnologías modernas para garantizar un rendimiento óptimo y la capacidad de crecer con las necesidades de tu empresa. Mi enfoque se centra en la eficiencia del código, la seguridad y la mantenibilidad a largo plazo.',
      image:
  ...
  public experienceCards = signal<ExperienceCard[]>([
    ...
    },
    {
      ...
      description:
        'Utilicé tecnologías como Angular e Ionic, y me ocupé del modelado de bases de datos y aspectos serverless. También programé en el frontend como Micro Frontend, asegurando la gestión del código a través de GIT para un flujo eficiente.',
      from: new Date(2021, 5, 1),
      to: new Date(2022, 10, 12),
    },
    {
      ...
      description:
        'Creé una página web para una óptica en Rancagua utilizando HTML, CSS, TypeScript y Angular, junto con RxJS, Bootstrap, Angular Material y Sass. Además, desarrollé un backend en PHP con una base de datos MySQL, manteniendo el código bajo control con GIT.',
      from: new Date(2021, 5, 1),
      to: new Date(2022, 10, 12),
    },
    {
  ...
  displayMoreExperience() {
    ...
    this.displayExperienceCards.set([
      ...this.displayExperienceCards(),
      ...next,
    ]);
  }
}
